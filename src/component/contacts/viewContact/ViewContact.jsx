          ...
          <div className="row align-items-center">
            ...
            <div className="col-md-8">
              <ul className="list-group">
                ...
                <li className="list-group-item list-group-item-action">
                  Company: <span className="fw-bold">Rajan33@gmail.com</span>
                </li>
                <li className="list-group-item list-group-item-action">
                  Title: <span className="fw-bold">Rajan33@gmail.com</span>
                </li>
                <li className="list-group-item list-group-item-action">
                  Group: <span className="fw-bold">Rajan33@gmail.com</span>
                </li>
